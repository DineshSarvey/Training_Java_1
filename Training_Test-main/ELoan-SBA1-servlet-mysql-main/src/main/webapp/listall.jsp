	...
	<c:forEach items="${listOfLists}" var="loanList" varStatus="count">
		...
		<table border="1">
	        <tr>
	            ...
	            <td>Mobile</td>
	            <td>Status</td>
	            <% if(pageContext.findAttribute("myCount") == ("Initiated")){
	        ...
	        <c:forEach items="${loanList}" var="loan">
	            <tr> 	 
		            ...
		            <td>
		            	...
		            	<input type="submit" name="submit" value="Approve" style={background-color: #4CAF50;}>
		            	<input type="submit" name="submit" value="Reject" style={background-color: #e7e7e7;}>
		            	</form>
		            </td>
